...
urlpatterns = [
    ...
    # re_path(r'^get_items/(?P<time>.+)$', grumblr.views.get_items, name='get_items'),
    ...
    re_path(r'^get_items/?$', grumblr.views.get_items),
    re_path(r'^get_items/(?P<time>.+)$', grumblr.views.get_items),
